...
/example\.(net|org)/`,
  ...
  embedPublish: {
    ...
    channelKeyHint: 'Из соображений безопасности ключи каналов не возвращаются в API списка. Если не сохранили — сбросьте для нового ключа (временно в сессии браузера).',
    ...
    originsCount: '{n} разрешённых доменов',
    ...
    tokenHint: 'Из соображений безопасности ключи не возвращаются в API списка. Сохраните ключ при создании или сбросе перед копированием виджета (в сессии браузера).',
    createdWithToken: 'Канал создан — новый ключ в поле ввода; скопируйте и сохраните сейчас',
    ...
    publishTokenHelp: 'Ключ канала (em_…) — долгоживущий секрет канала, как API Key. Показывается только при создании или сбросе; вставляется в скрипт виджета на сайте.',
    ...
    deployIntro: 'После сохранения выполните два шага для встраивания чата на сайт.',
