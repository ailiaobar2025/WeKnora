export default {
  ...
  uploadConfirm: {
    ...
    summaryTableInstructionsSet: 'Инструкции таблиц заданы',
    summaryTableInstructionsDefault: 'Инструкции таблиц по умолчанию',
    ...
    tabEnhancement: 'Обогащение контента',
...
/example\.(net|org)/`,
  ...
  organization: {
    ...
    inviteCodeTip: 'Поделитесь этим кодом приглашения с другими, чтобы они могли присоединиться к общему пространству',
    ...
    invite: {
      ...
      previewInfo: 'Обзор общего пространства',
    ...
    leaveConfirm: 'Вы уверены, что хотите покинуть это общее пространство?',
    ...
    deleteConfirm: 'Вы уверены, что хотите удалить это общее пространство? Это действие необратимо.',
    ...
    detail: {
      ...
      shareKBTip: 'В списке баз знаний выберите базу знаний и нажмите кнопку «Поделиться», чтобы поделиться ею в этом общем пространстве'
    },
    settings: {
      editTitle: 'Настройки общего пространства',
      detailTitle: 'Сведения об общем пространстве',
      myRoleDesc: 'Ваша роль в этом общем пространстве определяет объём ваших прав',
    ...
    addMember: {
      ...
      tip: 'Добавленные пользователи сразу станут участниками общего пространства и получат доступ к базам знаний, которыми поделились в общем пространстве.',
    ...
    share: {
      ...
      shareToSpace: 'Поделиться в общем пространстве',
      shareModelToSpace: 'Поделиться «{name}» в общем пространстве',
      shareAgentToSpace: 'Поделиться «{name}» в общем пространстве',
      modelShareDesc: 'Поделитесь моделью в общем пространстве, чтобы участники общего пространства могли её использовать',
      agentShareDesc: 'Поделитесь агентом в общем пространстве, чтобы участники общего пространства могли его использовать',
      spaceAgentShareCountTip: 'Количество агентов, которыми поделились в этом общем пространстве',
