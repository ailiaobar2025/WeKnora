export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and AI聊吧 parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  input: {
    ...
    placeholderAssistant: 'Ask {name}',
    assistantMode: 'Assistant',
    assistantSelector: {
      title: 'Select assistant',
      empty: 'No assistant is available. Ask an admin to assign one.',
    ...
    messages: {
      ...
      assistantSelected: 'Selected assistant "{name}"',
  ...
  createChat: {
    title: 'Hi, I am AI聊吧 — your knowledge, within reach',
