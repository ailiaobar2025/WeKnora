export default {
  ...
  uploadConfirm: {
    ...
    summaryTableInstructionsSet: "테이블 지침 설정됨",
    summaryTableInstructionsDefault: "기본 테이블 지침",
  ...
  knowledgeList: {
    ...
    emptyShared:
      "현재 공동 작업 지식베이스가 없습니다. 공유 공간에 참여하여 다른 사람들이 공유하는 지식베이스를 얻을 수 있습니다.",
    empty: {
      title: "지식베이스 없음",
      description:
      ...
      sharedDescription:
        "공유 공간에 참여하거나 다른 사람에게 지식베이스를 공유해 달라고 요청할 수 있습니다.",
      favoritesTitle: "즐겨찾기 없음",
      favoritesDescription: "카드의 별표 아이콘을 눌러 즐겨찾기에 추가하세요",
      recentsTitle: "최근 항목 없음",
  ...
  knowledgeEditor: {
    activity: {
      ...
      allOutcomes: '모든 결과', allActions: '모든 작업', refresh: '새로고침', retry: '다시 시도', empty: '아직 활동 기록이 없습니다', emptyFiltered: '일치하는 활동 기록이 없습니다', clearFilters: '필터 지우기',
      loadMore: '더 보기', loadingMore: '불러오는 중…', end: '이전 기록이 없습니다', loadFailed: '활동 기록을 불러오지 못했습니다', viewDetails: '상세 보기',
      columns: { time: '시간', action: '작업', target: '대상', actor: '시작자', outcome: '결과' },
      expanded: { targetType: '대상 유형', targetId: '대상 ID', actorId: '시작자 ID', details: '상세' },
      drawer: { sectionSummary: '요약', sectionIdentifiers: '식별자', sectionTask: '작업 정보', targetChange: '변경 내용' },
      systemActor: '시스템', knowledgeBase: '지식 베이스', countItems: '{count}개 항목', titleWithCount: '{title} 외 {count}개', importSummary: '성공 {success} / 실패 {failed} / 건너뜀 {skipped}',
      targets: { knowledge_base: '지식 베이스', knowledge: '지식', faq_entry: 'FAQ 항목', knowledge_tag: '태그', data_source: '데이터 소스', knowledge_base_share: '공유', knowledge_move: '지식 이동', wiki: 'Wiki' },
      outcomes: { accepted: '접수됨', success: '성공', failed: '실패', partial: '일부 완료', canceled: '취소됨', denied: '거부됨' },
      detailFields: { task_id: '작업 ID', trigger: '트리거', processing_status: '처리 상태', source_kb_id: '소스 지식 베이스 ID', target_kb_id: '대상 지식 베이스 ID', sync_log_id: '동기화 로그 ID', mode: '모드', attempt: '처리 시도', count: '항목 수', total: '전체', processed: '처리됨', failed: '실패', skipped: '건너뜀', failure_stage: '실패 단계' },
      detailValues: { user: '사용자 시작', manual: '수동', schedule: '예약', system: '시스템', pending: '대기 중', completed: '완료', partial: '일부 완료', canceled: '취소됨', failed: '실패', enqueue: '작업 제출', reuse_vectors: '벡터 재사용', reparse: '재분석', viewer: '읽기 전용', editor: '편집 가능', admin: '관리', append: '추가', replace: '덮어쓰기' },
      actions: {
        'kb.created': '지식 베이스 생성', 'kb.updated': '지식 베이스 업데이트', 'kb.deleted': '지식 베이스 삭제',
        'kb.duplicated': '지식 베이스 복제', 'kb.clone_started': '복제 시작', 'kb.clone_completed': '복제 완료',
        'kb.clone_failed': '복제 실패',
        'knowledge.created': '지식 추가', 'knowledge.updated': '지식 업데이트', 'knowledge.deleted': '지식 삭제',
        'knowledge.batch_deleted': '지식 일괄 삭제', 'knowledge.reparse_started': '재분석 시작',
        'knowledge.parse_canceled': '분석 취소', 'knowledge.move_started': '지식 이동 시작',
        'knowledge.move_completed': '지식 이동 완료', 'knowledge.move_failed': '지식 이동 실패',
        'tag.created': '태그 생성', 'tag.updated': '태그 업데이트', 'tag.deleted': '태그 삭제',
        'datasource.created': '데이터 소스 생성', 'datasource.updated': '데이터 소스 업데이트', 'datasource.deleted': '데이터 소스 삭제',
        'datasource.sync_started': '데이터 소스 동기화 시작', 'datasource.sync_completed': '데이터 소스 동기화 완료', 'datasource.sync_failed': '데이터 소스 동기화 실패',
        'datasource.paused': '데이터 소스 일시 중지', 'datasource.resumed': '데이터 소스 재개',
        'kb.share_added': '공유 추가', 'kb.share_permission_changed': '공유 권한 변경', 'kb.share_removed': '공유 제거',
        'wiki.content_changed': 'Wiki 콘텐츠 업데이트',
        'faq.import_started': 'FAQ 가져오기 시작', 'faq.import_completed': 'FAQ 가져오기 완료', 'faq.import_failed': 'FAQ 가져오기 실패',
      },
    },
  ...
  organization: {
    title: "공유 공간",
    subtitle:
      "공유 공간를 만들거나 참여하여 여러 스페이스가 함께 협업하고 지식베이스와 에이전트를 공유하세요.",
    createOrg: "공유 공간 생성",
    ...
    inviteCodeTip:
      "이 초대 코드를 다른 사람들과 공유하면 초대 코드를 통해 공유 공간에 참여할 수 있습니다.",
    ...
    join: {
      ...
      searchSpacesDesc:
        "검색이 가능한 공유 공간을 찾아보거나 검색해 보세요. 초대코드 없이도 참여할 수 있습니다.",
      searchSpacesPlaceholder: "공유 공간 이름, 설명 또는 ID로 검색",
      spaceId: "공유 공간 ID",
      noSearchResult: "일치하는 공유 공간을 찾을 수 없습니다.",
      noSearchableSpaces:
        "현재 검색 가능한 공개 공유 공간이 없거나, 키워드를 입력하여 검색하실 수 있습니다.",
    ...
    invite: {
      ...
      previewInfo: "공유 공간 개요",
      inputDesc:
        "초대코드를 입력하거나 초대링크에 초대코드를 붙여넣고 공유 공간 정보를 확인 후 참여하세요",
      previewAction: "확인하다",
      primaryJoin: "참여",
      invalidTitle: "잘못된 초대",
    ...
    leave: "공유 공간 나가기",
    leaveConfirm: "정말로 이 공유 공간을 나가시겠습니까?",
    leaveConfirmTitle: "공유 공간 나가기",
    leaveConfirmMessage:
      '정말로 "{name}" 공유 공간에서 나가시겠습니까? 나간 후에는 이 공유 공간에서 공유하는 지식베이스에 액세스할 수 없습니다.',
    leaveSuccess: "공유 공간을 나갔습니다.",
    leaveFailed: "공유 공간을 나가지 못했습니다.",
    deleteConfirm: "정말로 이 공유 공간을 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.",
    deleteConfirmTitle: "공유 공간 삭제",
    deleteConfirmMessage:
      '"{name}" 공유 공간을 삭제하시겠습니까? 삭제 후에는 모든 구성원이 제거되며 이 작업은 되돌릴 수 없습니다.',
    ...
    detail: {
      ...
      removeMember: "회원 삭제",
      shareKBTip:
        "지식베이스 목록에서 지식베이스를 선택하고 공유 버튼을 클릭하여 이 공유 공간에 공유하세요.",
    },
    settings: {
      editTitle: "공유 공간 설정",
      detailTitle: "공유 공간 세부정보",
      myRoleDesc: "이 공유 공간에서의 귀하의 역할은 귀하의 권한 범위를 결정합니다.",
      ...
      noSharedKBTip:
        "지식베이스 소유자는 지식베이스 설정에서 이 공유 공간에 지식베이스를 공유할 수 있습니다.",
      sharedAgents: "공유 에이전트",
      noSharedAgents: "아직 공유 에이전트가 없습니다.",
      sharedAgentsDesc: "이 공유 공간에 공유되었으며 대화에서 구성원이 사용할 수 있는 에이전트",
      sharedAgentsKbHint:
        "에이전트에 바인딩된 지식베이스는 구성원이 에이전트를 사용하여 대화하는 경우(읽기 전용) {'@'}에만 사용할 수 있으며 \"지식베이스 목록\"에는 표시되지 않습니다. 회원들이 목록에 있는 지식베이스를 보거나 편집할 수 있도록 하려면 이 공유 공간에 별도로 지식베이스를 공유해 주세요.",
      ...
      permissionCalcFormula:
        "공유 공간 권한은 공유 시 설정되며, 적용 권한은 공유 공간 권한과 내 공유 공간 역할 중 낮은 값입니다",
      permissionCalcTip:
        "적용 권한은 공유 공간 권한과 내 공유 공간 역할 중 낮은 값이며, 읽기 전용 구성원은 이 지식베이스에 읽기만 가능합니다.",
      inviteMembers: "회원 초대",
      ...
      removeShareConfirm:
        '이 공유 공간에서 "{name}"을(를) 제거하시겠습니까? 제거 후에는 공유 공간 구성원이 더 이상 지식베이스에 액세스할 수 없습니다.',
      removeAgentShareConfirm:
        '이 공유 공간에서 "{name}"을(를) 제거하시겠습니까? 제거 후에는 공유 공간 구성원이 더 이상 에이전트에 액세스할 수 없습니다.',
      ...
      searchableDesc:
        '오픈 후, "공유 공간 참여" 검색 목록에 해당 공유 공간이 나타납니다. 다른 사람도 초대코드 없이 검색하여 가입신청을 할 수 있습니다.',
      memberLimit: "최대 회원 수",
    ...
    editor: {
      ...
      permissionsDesc:
        "지식베이스와 에이전트를 통해 공유 공간 내 다양한 ​​역할의 권한 범위를 이해합니다.",
      ...
      ownerNote:
        "공유 공간 작성자로서 귀하는 자동으로 공유 공간의 관리자가 되며 모든 권한을 갖게 됩니다.",
    ...
    addMember: {
      button: "회원 추가",
      dialogTitle: "회원 추가",
      tip: "추가된 사용자는 즉시 공유 공간 구성원이 되며, 공유 공간에 공유된 지식베이스에 접근할 수 있습니다.",
    ...
    share: {
      title: "공유 공간에 공유",
      shareToSpace: "공유 공간에 공유",
      shareModelToSpace: '"{name}"을 공유 공간에 공유',
      shareAgentToSpace: '"{name}"을 공유 공간에 공유',
      modelShareDesc: "공유 공간 구성원이 모델을 사용할 수 있도록 모델을 공유 공간에 공유합니다.",
      agentShareDesc:
        "공유 공간 구성원이 에이전트를 사용할 수 있도록 에이전트를 공유 공간에 공유합니다.",
      spaceAgentShareCountTip: "공유 공간에 있는 공유 에이전트 수",
      selectOrg: "공유 공간 선택",
