export default {
  ...
  agent: {
    ...
    selector: {
      ...
      notReadyContactAdmin: "请联系管理员完成模型配置",
    },
    // 内置智能体信息
    builtinInfo: {
      quickAnswer: {
  ...
  input: {
    ...
    placeholderAssistant: "向 {name} 提问",
    assistantMode: "助手",
    assistantSelector: {
      title: "选择助手",
      empty: "暂无可用助手，请联系管理员分配",
      loadFailed: "助手列表加载失败",
    },
    agentMode: "智能推理",
    normalMode: "快速问答",
    ...
    agentNotReadyContactAdmin: "当前账号不能配置智能体模型，请联系管理员完成配置后再使用。",
