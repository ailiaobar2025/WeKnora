export default {
  ...
  uploadConfirm: {
    ...
    summaryTableInstructionsSet: "表格指令已设置",
    summaryTableInstructionsDefault: "表格指令默认",
  ...
  knowledgeEditor: {
    ...
    activity: {
      ...
      targets: { knowledge_base: "知识库", knowledge: "知识", faq_entry: "FAQ 条目", knowledge_tag: "标签", data_source: "数据源", knowledge_base_share: "共享", knowledge_move: "知识移动", wiki: "Wiki" },
      outcomes: { accepted: "已受理", success: "成功", failed: "失败", partial: "部分完成", canceled: "已取消", denied: "已拒绝" },
      detailFields: { task_id: "任务 ID", trigger: "触发方式", processing_status: "处理状态", source_kb_id: "来源知识库 ID", target_kb_id: "目标知识库 ID", sync_log_id: "同步记录 ID", mode: "执行模式", attempt: "处理批次", count: "项目数", total: "总数", processed: "已处理", failed: "失败数", skipped: "跳过数", failure_stage: "失败阶段" },
      detailValues: { user: "用户发起", manual: "手动触发", schedule: "定时调度", system: "系统触发", pending: "待处理", completed: "已完成", partial: "部分完成", canceled: "已取消", failed: "失败", enqueue: "任务提交", reuse_vectors: "复用向量", reparse: "重新解析", viewer: "只读", editor: "可编辑", admin: "管理", append: "追加", replace: "覆盖" },
      actions: {
        'kb.created': "创建知识库", 'kb.updated': "更新知识库", 'kb.deleted': "删除知识库",
        'kb.duplicated': "复制知识库", 'kb.clone_started': "开始克隆", 'kb.clone_completed': "完成克隆",
        'kb.clone_failed': "克隆失败",
        'knowledge.created': "添加知识", 'knowledge.updated': "更新知识", 'knowledge.deleted': "删除知识",
        'knowledge.batch_deleted': "批量删除知识", 'knowledge.reparse_started': "开始重新解析",
        'knowledge.parse_canceled': "取消解析", 'knowledge.move_started': "开始移动知识",
        'knowledge.move_completed': "完成移动知识", 'knowledge.move_failed': "移动知识失败",
        'tag.created': "创建标签", 'tag.updated': "更新标签", 'tag.deleted': "删除标签",
        'datasource.created': "创建数据源", 'datasource.updated': "更新数据源", 'datasource.deleted': "删除数据源",
        'datasource.sync_started': "开始同步数据源", 'datasource.sync_completed': "数据源同步完成", 'datasource.sync_failed': "数据源同步失败",
        'datasource.paused': "暂停数据源", 'datasource.resumed': "恢复数据源",
        'kb.share_added': "添加共享", 'kb.share_permission_changed': "修改共享权限", 'kb.share_removed': "移除共享",
        'wiki.content_changed': "更新 Wiki 内容",
        'faq.import_started': "开始导入 FAQ", 'faq.import_completed': "完成导入 FAQ", 'faq.import_failed': "导入 FAQ 失败",
      },
    },
    navGroups: {
      basic: "基础",
    ...
    wikiBrowser: {
      ...
      revisionDiff: "对比当前",
      revisionRaw: "查看原文",
      revisionDiffCaption: "v{from} → v{to}（红色为该版本内容，绿色为当前内容）",
  ...
  organization: {
    ...
    inviteCodeTip: "分享此邀请码给他人，他们可以通过邀请码加入共享空间",
    ...
    detail: {
      ...
      removeMember: "移除成员",
      shareKBTip: "在知识库列表中选择知识库，点击共享按钮将其共享到此共享空间",
    },
    settings: {
      editTitle: "共享空间设置",
      detailTitle: "共享空间详情",
      myRoleDesc: "您在此共享空间中的角色决定了您的权限范围",
    ...
    addMember: {
      button: "添加成员",
      dialogTitle: "添加成员",
      tip: "添加的用户将立即成为共享空间成员，可以访问共享空间内共享的知识库。",
    ...
    share: {
      ...
      modelShareDesc: "将模型共享到共享空间，共享空间成员可使用该模型",
  ...
  platformApiKeys: {
    ...
    create: "创建平台 API Key", createDescription: "平台 Key 不绑定空间，所有操作仍受能力范围限制。",
    loading: "正在加载…", empty: "暂无平台 API Key", name: "名称", namePlaceholder: "例如：集中运维自动化",
    key: "密钥", capability: "能力授权", capabilityMore: "+{count}", viewAllCapabilities: "查看全部能力授权", capabilityHint: "空间能力对任意 X-Tenant-ID 生效；系统能力用于平台控制面接口。",
    lastUsed: "最后使用", createdAt: "创建时间", actions: "操作", never: "从未使用",
    systemCapabilityGroup: "平台控制面",
    capabilities: { tenantsRead: "查看空间", tenantsManage: "管理空间", settingsRead: "查看系统设置", settingsManage: "管理系统设置", runtimeRead: "查看运行时", runtimeManage: "管理运行时", auditRead: "查看系统审计" },
    capabilityHints: { tenantsRead: "列出、搜索和查看所有空间。", tenantsManage: "创建、更新、删除空间及应用全局空间配置。", settingsRead: "读取平台级运行设置。", settingsManage: "更新和重置平台级运行设置。", runtimeRead: "查看任务队列和任务详情。", runtimeManage: "重试、立即执行、取消或删除运行时任务。", auditRead: "读取平台级审计日志。" },
    createdTitle: "平台 API Key 已创建", createdDescription: "请立即复制并安全保存。关闭后将不再显示完整密钥。",
    copy: "复制密钥", copySuccess: "密钥已复制",
    deleteConfirm: "确定删除“{name}”吗？使用该 Key 的自动化将立即失效。", deleteSuccess: "平台 API Key 已删除", deleteFailed: "删除平台 API Key 失败",
    nameRequired: "请输入名称", capabilityRequired: "请至少选择一项能力", loadFailed: "加载平台 API Key 失败", createFailed: "创建平台 API Key 失败",
  },
};
