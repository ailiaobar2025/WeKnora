<template>
  <div class="login-layout">
    ...
    <div class="header-links">
      <a v-if="!isKnowHubProductMode()" href="https://weknora.weixin.qq.com" target="_blank" class="header-link" :title="$t('common.website')">
      ...
      <a v-if="!isKnowHubProductMode()" href="https://github.com/Tencent/WeKnora" target="_blank" class="header-link" :title="$t('common.info')">
